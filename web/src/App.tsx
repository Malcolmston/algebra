...
export function App() {
  ...
  const brand = { title: 'malcolmston', sub: '/algebra', initials: 'ab', href: '#overview' };
  const footer: ReactNode = (
    <div>
      <span className="grad-text" style={{ fontWeight: 700 }}>malcolmston/algebra</span> — symbolic algebra, reimagined in Go.
      <div className="small dim" style={{ marginTop: '.4rem' }}>MIT licensed · independent re-implementation of sympy/sympy</div>
    </div>
  );

  return (
    <Layout brand={brand} tabs={TABS} active={active} onNav={go} github="https://github.com/malcolmston/algebra" footer={footer}>
