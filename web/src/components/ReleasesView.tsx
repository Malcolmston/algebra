...
import { ALGEBRA } from '../data';

// Scoped to this repository only: the live release history is read straight from
// the GitHub Releases API for malcolmston/algebra.
const RELEASE_LIBS: RelLib[] = [
  { name: ALGEBRA.name, icon: ALGEBRA.icon, accent: ALGEBRA.accent, repo: ghrepo(ALGEBRA), url: ALGEBRA.repo },
];
